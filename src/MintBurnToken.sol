...
contract MintBurnToken is IMintBurnERC20, ERC20, Ownable {
     ...
     */
    function mint(address receiver, uint256 amount) external onlyFromFactory override {
     ...
     */
    function burn(address from, uint256 amount) external onlyFromFactory override {
        _burn(from, amount);
